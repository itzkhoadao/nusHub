...
CREATE TABLE IF NOT EXISTS message_attachments (
  ...
  original_name TEXT NOT NULL, -- name of file in user's device (display this)
  stored_name TEXT NOT NULL, -- name stored in backend (generated, our system save this)
  storage_provider TEXT NOT NULL DEFAULT 'r2',
  storage_key TEXT,
  mime_type TEXT NOT NULL, -- media type
